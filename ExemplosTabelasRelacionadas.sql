...
-- Consulta parte da tabela de clientes fazendo o INNER JOIN com a tabela de endereço
SELECT
	c.nome,
	c.cpf,
	CONCAT(
...
-- Consultar pedidos listando data de criação formato PT-BR, status com texto e nome do cliente
...
-- quantidade, valor_unitario, total das pecas
SELECT 
...
-- Consultar as peças do pedido do Claúdio
SELECT
	p.id AS 'Código Pedido',
	p.status AS 'Status Pedido',
	c.nome AS 'Cliente',
